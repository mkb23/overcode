...
def launch(
    ...
    model: Annotated[
        Optional[str],
        typer.Option("--model", "-m", help="Model (e.g. sonnet, opus; openai/gpt-4o-mini for opencode; gpt-5.6-sol for codex)"),
    ] = None,
    ...
    backend: Annotated[
        ...
        typer.Option("--backend", "-B", help="Agent CLI backend: claude-code (default), opencode, or codex"),
    ] = None,
    wrapper: Annotated[
        Optional[str],
