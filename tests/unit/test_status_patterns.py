...
class TestExtractSleepDuration:
    ...
    def test_enriched_activity_string(self):
        """Should extract duration from enriched activity like 'Sleeping 300s'."""
        assert extract_sleep_duration("Sleeping 300s") == 300
        assert extract_sleep_duration("Sleeping 60s") == 60
        assert extract_sleep_duration("Sleeping 20s") == 20
    ...
    def test_formatted_duration_seconds_unit(self):
        """Should parse 'Sleeping 45s' via formatted pattern."""
